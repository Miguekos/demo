    ...
    framework: {
      ...
      config: {
        ...
        loading: {
          ...
          message: "<div id='corazon'><img color='grey' style='height: 110px; max-width: 120px;' src='https://api.apps.com.pe/fileserver/uploads/corazonlogo.png'></img><div class='text-center text-bold text-h6 text-red-5'>Cargando..</div></div>",
          // messageColor: "white",
